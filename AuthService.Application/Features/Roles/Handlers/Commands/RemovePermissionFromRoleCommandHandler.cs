...
public class RemovePermissionFromRoleCommandHandler : IRequestHandler<RemovePermissionFromRoleCommand, Result<bool>>
{
    ...
    public RemovePermissionFromRoleCommandHandler(IRoleRepository roleRepository, IPermissionRepository permissionRepository, IUnitOfWork unitOfWork)
    {
    ...
    public async Task<Result<bool>> Handle(RemovePermissionFromRoleCommand request, CancellationToken cancellationToken)
    {
        ...
        {
            return ApplicationError.RoleDoesNotHavePermission(role.RoleName, permission.PermissionName);
        }
        
        role.RemovePermissionIfBelongs(permission);
